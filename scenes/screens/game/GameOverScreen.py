...
class GameOverScreen:
    ...
    def __init__(self, screen, scene_hub):
        ...
        self.text = font.render("Игра окончена Ты проиграл", True, (255, 0, 0))
        self.text_rect = self.text.get_rect(center=self.screen.get_rect().center)

        self.again_button = Button(Config.X_SCREEN // 2 - 100, Config.Y_SCREEN // 2 + 50, 200, 50, "Сначала", BUTTON_GRAY, GREEN)
        self.main_menu_button = Button(Config.X_SCREEN // 2 - 100, Config.Y_SCREEN // 2 + 50 + 75, 200, 50, "Меню", BUTTON_GRAY, GREEN)
